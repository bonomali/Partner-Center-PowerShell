...
namespace Microsoft.Azure.Management.Subscription
{
    ...
    public static partial class SubscriptionOperationsExtensions
    {
        ...
        /// </param>
        public static CanceledSubscriptionId Cancel(this ISubscriptionOperations operations, string subscriptionId, bool ignoreResourceCheck)
        {
        ...
        /// The cancellation token.
        /// </param>
        public static async Task<CanceledSubscriptionId> CancelAsync(this ISubscriptionOperations operations, string subscriptionId, bool ignoreResourceCheck, CancellationToken cancellationToken = default(CancellationToken))
        {
            using (var _result = await operations.CancelWithHttpMessagesAsync(subscriptionId, true, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
            }
        }
